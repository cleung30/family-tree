            ...
            {GROUPS.map(group => {
              ...
              return (
                <div key={group.key} style={{ marginBottom: 16 }}>
                  <h3 style={{ fontSize: 12, fontWeight: 700, textTransform: 'uppercase', color: '#8a3f56', marginBottom: 6 }}>{group.label}</h3>
                          ...
                          {relation.han ? (
                            <>
                              <div style={{ display: 'flex', alignItems: 'center', gap: 4, justifyContent: 'flex-end' }}>
                                <span style={{ fontSize: 16, fontWeight: 700, color: '#722F37' }}>{relation.han}</span>
